...
public class RemoveAdminPlanTest {
    ...
    @Test(description = "Remove user plans as admin")
    @Severity(SeverityLevel.BLOCKER)
    @Feature("Get all plans")
    public void removeAdminPlan() throws IOException {
        ...
        String result = client.deletePlan(adminToken, planPojo.id);
        Logger.debug("Admin delete plans: " + result);
    }
