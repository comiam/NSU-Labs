...
public class RemoveCustomerTwiceTest {
    ...
    @Test(description = "Delete customer as admin", dependsOnMethods = "deleteCustomerAsAdminTest")
    @Severity(SeverityLevel.BLOCKER)
    @Feature("Remove customer feature")
    public void deleteCustomerAsAdminAgainTest() {
        new RestClient().removeCustomer(customerPojo.id, adminToken);
    }
